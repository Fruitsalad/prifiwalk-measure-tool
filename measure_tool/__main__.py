...
MODE__GENERATE_HISTOGRAMS = 1
MODE__PRINT_STATISTICS = 2
...
def parse_args():
    ...
    parser.add_argument('mode',
                        help=f'{MODE__GENERATE_HISTOGRAMS} to generate ' +
                             'histograms, ' +
                             f'{MODE__PRINT_STATISTICS} to print statistics',
                        type=int)
...
if __name__ == '__main__':
    ...
    if args.mode == MODE__GENERATE_HISTOGRAMS:
        generate_histograms(wildfrag)
    elif args.mode == MODE__PRINT_STATISTICS:
